  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-blue-800 flex flex-col items-center justify-center p-6">
      <div className="bg-white rounded-3xl shadow-2xl p-10 max-w-md w-full text-center">
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-2">RentEasy</h1>
        <p className="text-xl text-gray-500 mb-2">Chairs, Tables, Videoke & More</p>
        <p className="text-lg text-gray-400 mb-8">Event equipment rentals near you</p>
        <button
        ...
        <p className="mt-6 text-gray-400 text-lg">Free to use • Secure • Easy</p>
      </div>
    </div>
  );
}
