...
const EN_TEXT: StaffTourText = {
  common: {
    infoButton: 'Info',
    openVendorGuideAriaLabel: 'Open rental partner guide',
    openAdminGuideAriaLabel: 'Open admin guide',
    openVendorGuideTitle: 'How to use rental partner portal',
    openAdminGuideTitle: 'How to use admin portal',
    openGuideAfterSignIn: 'Open this guide after signing in as rental partner or admin for role-specific instructions.',
  },
  vendor: {
    panelLabel: 'Rental Partner Panel',
    step1Title: 'Rental Partner Guide',
    step1Body: 'Use this guide for day-to-day rental partner operations: setup shop, manage inventory, process bookings, and monitor payouts.',
    step2Title: 'Rental Partner Navigation',
    ...
    step5Body: 'Track billing obligations and payout releases. New rental partners have payout hold windows until they pass the completed-orders threshold configured by admin.',
  ...
  admin: {
    ...
    step2Body: 'The sidebar gives access to Customers, Applicants, Rental Partners, Item Types, Brands, Payments, Fraud Alerts, Disputes, and Feature Flags.',
    step3Title: 'Core Admin Use Cases',
    step3Item1: 'Review and approve/decline rental partner KYC applications.',
    step3Item2: 'Moderate rental partners with verify, warn, suspend, and suspicious-flag actions.',
    step3Item3: 'Manage customers and perform account impersonation for support.',
    step4Title: 'Payments and Payout Operations',
    step4Item1: 'Create and track rental partner billing records.',
    step4Item2: 'Mark billing records as overdue or paid.',
    step4Item3: 'Release ready rental partner payouts after delivery confirmation.',
    step5Title: 'Risk, Disputes, and Policy Controls',
    step5Item1: 'Triage fraud alerts by status and type.',
    step5Item2: 'Resolve disputes with full refund, partial refund, or release-to-rental-partner outcomes.',
...
const TL_TEXT: StaffTourText = {
  common: {
    infoButton: 'Info',
    openVendorGuideAriaLabel: 'Buksan ang rental partner guide',
    openAdminGuideAriaLabel: 'Buksan ang admin guide',
    openVendorGuideTitle: 'Paano gamitin ang rental partner portal',
    openAdminGuideTitle: 'Paano gamitin ang admin portal',
    openGuideAfterSignIn: 'Buksan ang guide na ito pagkatapos mag-sign in bilang rental partner o admin para sa role-specific na instructions.',
  },
  vendor: {
    panelLabel: 'Rental Partner Panel',
    step1Title: 'Rental Partner Guide',
    step1Body: 'Gamitin ang guide na ito para sa araw-araw na rental partner operations: setup ng shop, inventory management, booking processing, at payout monitoring.',
    step2Title: 'Rental Partner Navigation',
    ...
    step5Body: 'I-track ang billing obligations at payout releases. Ang new rental partners ay may payout hold hanggang maabot nila ang completed-orders threshold na naka-configure ng admin.',
  ...
  admin: {
    ...
    step2Body: 'Ang sidebar ay may access sa Customers, Applicants, Rental Partners, Item Types, Brands, Payments, Fraud Alerts, Disputes, at Feature Flags.',
    step3Title: 'Core Admin Use Cases',
    step3Item1: 'I-review at i-approve/i-decline ang rental partner KYC applications.',
    step3Item2: 'I-moderate ang rental partners gamit ang verify, warn, suspend, at suspicious-flag actions.',
    ...
    step4Item1: 'Gumawa at mag-track ng rental partner billing records.',
    step4Item2: 'I-mark ang billing records bilang overdue o paid.',
    step4Item3: 'I-release ang ready rental partner payouts pagkatapos ng delivery confirmation.',
    step5Title: 'Risk, Disputes, at Policy Controls',
    step5Item1: 'I-triage ang fraud alerts ayon sa status at type.',
    step5Item2: 'I-resolve ang disputes gamit ang full refund, partial refund, o release-to-rental-partner outcomes.',
