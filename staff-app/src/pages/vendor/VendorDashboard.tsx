...
function BreakdownArmy() {
  const { breakdownLoading, breakdown, colorMap, ITEM_PALETTE } = (window as any).dashboardProps || {};
  // fallback for direct use in component
  if (typeof breakdownLoading === 'undefined') {
    // @ts-ignore
    return null;
  }
  if (breakdownLoading) return <LoadingSpinner size="md" />;
