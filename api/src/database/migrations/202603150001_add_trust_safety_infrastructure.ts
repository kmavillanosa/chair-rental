  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    if (!(await queryRunner.hasColumn('users', 'lastLoginIp'))) {
    ...
    if (!(await queryRunner.hasColumn('vendors', 'bankName'))) {
      await queryRunner.query(`
        ALTER TABLE vendors
    ...
    if (!(await queryRunner.hasColumn('bookings', 'depositPercentage'))) {
      await queryRunner.query(`
        ALTER TABLE bookings
    ...
    if (!(await queryRunner.hasTable('vendor_payouts'))) {
      await queryRunner.query(`
    ...
    if (!(await queryRunner.hasTable('booking_messages'))) {
      await queryRunner.query(`
    ...
    if (!(await queryRunner.hasTable('booking_reviews'))) {
      await queryRunner.query(`
    ...
    if (!(await queryRunner.hasTable('booking_delivery_proofs'))) {
      await queryRunner.query(`
    ...
    if (!(await queryRunner.hasTable('booking_disputes'))) {
      await queryRunner.query(`
    ...
    if (!(await queryRunner.hasTable('booking_dispute_evidence'))) {
      await queryRunner.query(`
    ...
    if (!(await queryRunner.hasTable('fraud_alerts'))) {
      await queryRunner.query(`
