...
const ADMIN_PACKAGE_SEED_DEFINITIONS: AdminPackageSeedDefinition[] = [
  {
    ...
    description:
      'Core reception package with seating, tables, tent cover, and stage backdrop.',
    items: [
      { itemTypeName: 'Monoblock chairs', requiredQty: 100, suggestedUnitPrice: 25 },
      { itemTypeName: 'Round banquet tables', requiredQty: 12, suggestedUnitPrice: 300 },
      { itemTypeName: 'Open tent', requiredQty: 2, suggestedUnitPrice: 8000 },
      { itemTypeName: 'Backdrop frames', requiredQty: 1, suggestedUnitPrice: 4500 },
    ],
  },
  {
    code: 'birthday_essentials',
    name: 'Birthday Essentials Package',
    description:
      'Starter package for birthdays with tents, table seating, and basic lights.',
    items: [
      { itemTypeName: 'Monoblock chairs', requiredQty: 60, suggestedUnitPrice: 25 },
      { itemTypeName: 'Rectangular banquet tables', requiredQty: 8, suggestedUnitPrice: 280 },
      { itemTypeName: 'Open tent', requiredQty: 1, suggestedUnitPrice: 7000 },
      { itemTypeName: 'PAR lights', requiredQty: 6, suggestedUnitPrice: 500 },
    ],
  },
  {
    code: 'corporate_program',
    name: 'Corporate Program Package',
    description:
      'Program-ready package with chairs, stage, sound, and lighting.',
    items: [
      { itemTypeName: 'Folding chairs', requiredQty: 80, suggestedUnitPrice: 35 },
      { itemTypeName: 'Modular stage platforms', requiredQty: 12, suggestedUnitPrice: 1200 },
      { itemTypeName: 'PA speakers', requiredQty: 4, suggestedUnitPrice: 2200 },
      { itemTypeName: 'PAR lights', requiredQty: 8, suggestedUnitPrice: 500 },
    ],
  },
];
